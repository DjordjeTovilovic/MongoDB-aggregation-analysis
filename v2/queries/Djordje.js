//1. Prosecna plata programera i seniora u Velikoj Britaniji i Njemacka
...
db.getCollection("benefits").aggregate([
  {
    $group: {
      _id: { currentJob: "$_id.currentJob" },
      rating: { $avg: "$_id.rating" },
    },
  },
]);
