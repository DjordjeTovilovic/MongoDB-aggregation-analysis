...
db.industries.aggregate([
    {$match : {"_id.location" : "London"}},
    {$project: {industry : "$_id.industry" , number: "$number" , location: "$_id.location"}},
    {$match: {"number" : {$gt : 0}}},
    {$sort: {"number" : -1}},
...
db.industries.aggregate([
    ...
    {$match : { $or : [{"_id.jobTitle" : {$regex : "Software"}}, {"_id.jobTitle" : {$regex : "software"}} , {"_id.jobTitle" : {$regex : "front"}} , {"_id.jobTitle" : {$regex : "Front"}}]}},
...
db.benefits_comments.aggregate([
    {$match : { $or: [ {"_id.comments" : {$regex : "Sport"}}, {"_id.comments" : {$regex : "sport"}} , {"_id.comments" : {$regex : "Sports"}}, {"_id.comments" : {$regex : "sports"}}]}},
...
// Koja je prosecna ocena benefita u Londonu koji u svojim uslugama imaju benefit "rad od kuce"?
    db.benefits_comments.aggregate([
    {$match: {$and: [{"_id.location" : "London"}, {$or : [ {"_id.comments" : {$regex : "work from home"}} ,{"_id.comments" : {$regex : "Work from home"}} ]}  ]}},
    {$group: {"_id" : null,"average_benefit_rating" : {$avg : "$_id.benefitRating"}}},
